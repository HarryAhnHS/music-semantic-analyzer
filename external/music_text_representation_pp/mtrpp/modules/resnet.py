...
from external.music_text_representation_pp.mtrpp.modules.mel import MelEncoder
from external.music_text_representation_pp.mtrpp.modules.pooling_layer import AttentionPool2d
